...
namespace BizHawk.Client.EmuHawk
{
		...
		IMainFormForApi, IMainFormForRetroAchievements, IMainFormForTools
	{
			...
			out bool exitEarly)
		{
			...
			_genieBridgeHost = new GenieBridgeHost();
			_genieBridgeHost.Start();
			_ = _genieBridgeHost.TryBootstrapFromManifest(Path.Combine(AppContext.BaseDirectory, "Genie.bootstrap.json"), "EmuHawk");
		...
		protected override void Dispose(bool disposing)
		{
			...
			_genieBridgeHost?.Dispose();
			_genieBridgeHost = null;
...
//				Util.DebugWriteLine($"  Selecting display size {lastComputedSize}");
		...
		private GenieBridgeHost _genieBridgeHost;
