...
#pragma warning restore MA0136
		...
		public string OnQueryItemBg(LuaFunction luaf, string name = null)
		{
			if (Engaged())
			{
				var nlf = CreateAndRegisterNamedFunction(luaf, "OnQueryItemBg", ApiGroup.PROHIBITED_MID_FRAME, name: name);
				TAStudio.QueryColor callback = (index, name) => _th.SafeParseColor(nlf.Call(index, name)?.FirstOrDefault());
		...
		public string OnQueryItemText(LuaFunction luaf, string name = null)
		{
			if (Engaged())
			{
				var nlf = CreateAndRegisterNamedFunction(luaf, "OnQueryItemText", ApiGroup.PROHIBITED_MID_FRAME, name: name);
				TAStudio.QueryText callback = (index, name) => nlf.Call(index, name)?.FirstOrDefault()?.ToString();
		...
		public string OnQueryItemIcon(LuaFunction luaf, string name = null)
		{
			if (Engaged())
			{
				var nlf = CreateAndRegisterNamedFunction(luaf, "OnQueryItemIcon", ApiGroup.PROHIBITED_MID_FRAME, name: name);
				TAStudio.QueryIcon callback = (index, name) =>
				{
					var result = nlf.Call(index, name);
		...
		public string OnGreenzoneInvalidated(LuaFunction luaf, string name = null)
		{
			if (Engaged())
			{
				...
				Action<int> callback = index => nlf.Call(index);
